...
contract("Colony Funding", accounts => {
  ...
  describe("when receiving tokens", () => {
    it("should not put the tokens straight in to the pot", async () => {
      ...
      expect(colonyPotBalance).to.eq.BN(0);
      expect(colonyRewardPotBalance).to.eq.BN(0);
